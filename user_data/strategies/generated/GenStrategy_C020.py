"""Auto-generated strategy: Five-Minute Fair Value Gap Long to Asian Range High
  ID: C020 | Tier: tier2 | Source: composed
...
class GenStrategy_C020(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C020_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C020_short"]
        return dataframe
