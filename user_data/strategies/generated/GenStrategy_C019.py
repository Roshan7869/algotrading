"""Auto-generated strategy: Bearish Previous Day High Sweep with FVG Short
  ID: C019 | Tier: tier2 | Source: composed
...
class GenStrategy_C019(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C019_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C019_short"]
        return dataframe
