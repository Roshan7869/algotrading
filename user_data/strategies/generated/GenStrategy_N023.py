"""Auto-generated strategy: Chris Verma Systematic Gap Short Strategy
  ID: N023 | Tier: tier2 | Source: natural_group
  Components: entry: 3, filter: 3, risk_management: 2, trade_management: 2 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N023(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N023_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N023_short"]
        return dataframe
