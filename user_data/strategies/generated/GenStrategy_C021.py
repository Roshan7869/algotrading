"""Auto-generated strategy: Weighted DCA — Triple Size at 30%+ Drawdowns
  ID: C021 | Tier: tier2 | Source: composed
...
class GenStrategy_C021(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C021_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C021_short"]
        return dataframe
