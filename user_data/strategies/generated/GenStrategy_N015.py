"""Auto-generated strategy: Okala's 8020 Strategy
  ID: N015 | Tier: tier1 | Source: natural_group
  Components: entry: 3, filter: 3, risk_management: 1, psychology: 1, market_structure: 1, trade_management: 1 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N015(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N015_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N015_short"]
        return dataframe
