"""Auto-generated strategy: Opening Range Breakout Intraday Trend Follow
  ID: C026 | Tier: tier1 | Source: composed
  Components: entry: 1, exit: 1, filter: 1, risk_management: 1 | Chunks: 4
"""
import numpy as np
import pandas as pd
...
class GenStrategy_C026(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Entry: trend_follow
        long_conditions = (dataframe["close"] > dataframe["ema_trend"]) & (dataframe["ema_fast"] > dataframe["ema_medium"]) & (dataframe["adx"] > 20)

        # Short:
        short_conditions = (dataframe["close"] < dataframe["ema_trend"]) & (dataframe["ema_fast"] < dataframe["ema_medium"]) & (dataframe["adx"] > 20)
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C026_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C026_short"]
        return dataframe
