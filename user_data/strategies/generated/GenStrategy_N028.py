"""Auto-generated strategy: Order Flow Trader Reveals Exact System
  ID: N028 | Tier: tier1 | Source: natural_group
  Components: entry: 6, exit: 3, filter: 2, risk_management: 7, psychology: 7, market_structure: 5, trade_management: 1 | Chunks: 31
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N028(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N028_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N028_short"]
        return dataframe
