"""Auto-generated strategy: High Volume Signal Candle at VP Edge
  ID: C023 | Tier: tier2 | Source: composed
  Components: entry: 1, exit: 1, filter: 1, psychology: 1 | Chunks: 4
"""
import numpy as np
import pandas as pd
...
class GenStrategy_C023(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C023_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C023_short"]
        return dataframe
