"""Auto-generated strategy: LIVE Trading with a $1M+ Order Flow Trader
  ID: N008 | Tier: tier1 | Source: natural_group
  Components: entry: 1, filter: 3, risk_management: 1, psychology: 2, market_structure: 2, trade_management: 1 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N008(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N008_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N008_short"]
        return dataframe
