"""Auto-generated strategy: Liquidity Sweep Reversal with Stop Placement Below Swept Low
  ID: C027 | Tier: tier2 | Source: composed
  Components: entry: 1, exit: 1, filter: 1 | Chunks: 3
"""
import numpy as np
import pandas as pd
...
class GenStrategy_C027(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C027_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C027_short"]
        return dataframe
