"""Auto-generated strategy: Support & Resistance Levels, Mindset & Sizing For Zero
  ID: N026 | Tier: tier2 | Source: natural_group
  Components: entry: 1, filter: 1, risk_management: 1, psychology: 1, market_structure: 1 | Chunks: 5
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N026(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N026_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N026_short"]
        return dataframe
