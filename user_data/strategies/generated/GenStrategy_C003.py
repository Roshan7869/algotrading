"""Auto-generated strategy: Leverage Play via Bitcoin-Correlated Equity
  ID: C003 | Tier: tier2 | Source: composed
...
class GenStrategy_C003(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C003_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C003_short"]
        return dataframe
