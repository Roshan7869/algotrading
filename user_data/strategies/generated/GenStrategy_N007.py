"""Auto-generated strategy: Candlesticks & Candlestick Patterns
  ID: N007 | Tier: tier1 | Source: natural_group
  Components: entry: 7, filter: 1, risk_management: 1, psychology: 1 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N007(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False

    minimal_roi = {"0": 0.10, "60": 0.05, "120": 0.02, "240": 0.01}
    stoploss = -0.06
    trailing_stop = True
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N007_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N007_short"]
        return dataframe
