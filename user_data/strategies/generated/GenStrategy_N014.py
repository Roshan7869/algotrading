"""Auto-generated strategy: STEAL This EASY Liquidity TRAP Trading Strategy - $500K+
  ID: N014 | Tier: tier1 | Source: natural_group
  Components: entry: 5, exit: 1, filter: 1, risk_management: 2, psychology: 2, market_structure: 4 | Chunks: 15
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N014(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N014_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N014_short"]
        return dataframe
