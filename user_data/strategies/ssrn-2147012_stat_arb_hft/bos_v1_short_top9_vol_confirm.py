...
class BOS_V1_ShortTop9_VolConfirm(IStrategy):
    INTERFACE_VERSION = 3
    can_short = True
    timeframe = "1h"
    ...
    def _compute_volume_confirm(self, df):
        # Paper 2 (ssrn-2147012): HFT increases cointegration.
        # High volume = active HFT participation = more reliable BOS signals.
        # Only enter when volume exceeds 24h average (active trading regime).
    ...
    def populate_entry_trend(self, dataframe, metadata):
        # SHORT: 3-of-4 pillars + RSI > 30 + volume confirmation
        dataframe.loc[
