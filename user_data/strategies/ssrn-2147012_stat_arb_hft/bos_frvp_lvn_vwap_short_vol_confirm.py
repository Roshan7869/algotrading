"""
BOS + FRVP + LVN + VWAP — SHORT Only Strategy (+ Volume Confirmation)
======================================================================
...
class BOS_FRVP_LVN_VWAP_Short_VolConfirm(IStrategy):
    INTERFACE_VERSION = 3
    can_short = True
    timeframe = "1h"
    ...
    def populate_entry_trend(self, dataframe, metadata):
        # SHORT: 3-of-4 pillars + RSI > 35 + volume confirmation
        dataframe.loc[
