"""
ChromaDB Vector Strategy — P3C: Wider Trailing (Swing Range)
==============================================================
P2★ baseline with wider trailing stop for swing trades.

Enhancement:
  - trailing_stop_positive = 0.04 (4% instead of 2.5%)
  - trailing_stop_positive_offset = 0.06 (6% instead of 4%)
  - ChromaDB recommends 5-8% for swing trades; this tests the middle-ground
...
class VectorStrategy_P3C_WIDER_TRAIL(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def _record_outcome(self, trade: Trade, profit_pct: float) -> None:
        try:
            ...
            record = {
                ...
                "is_win": is_win,
                "strategy": "VectorStrategy_P3C_WIDER_TRAIL",
