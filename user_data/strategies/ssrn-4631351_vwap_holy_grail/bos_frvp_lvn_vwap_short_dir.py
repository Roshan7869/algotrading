"""
BOS + FRVP + LVN + VWAP — SHORT Only Strategy (+ Directional Filter)
=====================================================================
The 4-pillar strategy works best on the SHORT side.
This variant is SHORT-only with tighter risk management.

VWAP directional filter: short only when price BELOW VWAP.
...
class BOS_FRVP_LVN_VWAP_Short_Dir(IStrategy):
    INTERFACE_VERSION = 3
    can_short = True
    timeframe = "1h"
