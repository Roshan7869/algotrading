"""Auto-generated strategy: The SIMPLE $10 Million ICT Blueprint They Don't Want You ...
  ID: N024 | Tier: tier1 | Source: natural_group
  Components: entry: 4, filter: 5, risk_management: 1, psychology: 2, market_structure: 4 | Chunks: 16
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N024(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N024_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N024_short"]
        return dataframe
