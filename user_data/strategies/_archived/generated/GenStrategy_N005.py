"""Auto-generated strategy: Best Day Trading Strategy
  ID: N005 | Tier: tier1 | Source: natural_group
  Components: entry: 2, filter: 2, risk_management: 1, psychology: 1, market_structure: 2 | Chunks: 8
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N005(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N005_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N005_short"]
        return dataframe
