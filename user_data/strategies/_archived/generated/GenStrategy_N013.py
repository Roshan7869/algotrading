"""Auto-generated strategy: Complete Price Action Trading Guide
  ID: N013 | Tier: tier2 | Source: natural_group
  Components: entry: 2, filter: 2, market_structure: 3 | Chunks: 7
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N013(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N013_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N013_short"]
        return dataframe
