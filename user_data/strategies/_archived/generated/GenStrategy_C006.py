"""Auto-generated strategy: Gap Open Two-Level Trade Setup
  ID: C006 | Tier: tier1 | Source: composed
...
class GenStrategy_C006(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C006_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C006_short"]
        return dataframe
