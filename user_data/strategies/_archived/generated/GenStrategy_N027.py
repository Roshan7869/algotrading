"""Auto-generated strategy: Order Flow Trading Masterclass Part 2
  ID: N027 | Tier: tier1 | Source: natural_group
  Components: entry: 4, filter: 4, market_structure: 2 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N027(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N027_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N027_short"]
        return dataframe
