"""Auto-generated strategy: Proxy Investment via Strategic Partnership Announcement
  ID: C002 | Tier: tier1 | Source: composed
  Components: entry: 1, exit: 1, filter: 1, risk_management: 1, market_structure: 1 | Chunks: 5
"""
import numpy as np
import pandas as pd
...
class GenStrategy_C002(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C002_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C002_short"]
        return dataframe
