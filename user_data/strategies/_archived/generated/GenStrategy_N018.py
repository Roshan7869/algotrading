"""Auto-generated strategy: How to Build a Profitable Trading Strategy From Scratch
  ID: N018 | Tier: tier1 | Source: natural_group
  Components: entry: 1, filter: 2, risk_management: 1, psychology: 1 | Chunks: 5
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N018(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Entry: divergence
        long_conditions = dataframe["bullish_div"] & (dataframe["rsi"] < 50)

        # Short:
        short_conditions = dataframe["bearish_div"] & (dataframe["rsi"] > 50)
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N018_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N018_short"]
        return dataframe
