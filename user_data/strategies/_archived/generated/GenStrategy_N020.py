"""Auto-generated strategy: 20-Year Trader Reveals His Exact 3-Phase Market Environme...
  ID: N020 | Tier: tier1 | Source: natural_group
  Components: entry: 3, filter: 3, risk_management: 1, market_structure: 1, trade_management: 2 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N020(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Entry: bb_squeeze
        squeezed = dataframe["bb_width"] < dataframe["bb_width"].rolling(50).mean()
        ...
        # Short:
        short_conditions = squeezed & expanding & (dataframe["close"] < dataframe["bb_lower"])
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N020_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N020_short"]
        return dataframe
