"""Auto-generated strategy: Market Structure Shift as Entry Trigger
  ID: C012 | Tier: tier1 | Source: composed
...
class GenStrategy_C012(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C012_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C012_short"]
        return dataframe
