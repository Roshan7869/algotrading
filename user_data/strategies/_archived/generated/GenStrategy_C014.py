"""Auto-generated strategy: S&P 500 Historical Correction Level Confluence (−10%/−20% Bounce Zo...
  ID: C014 | Tier: tier1 | Source: composed
...
class GenStrategy_C014(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C014_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C014_short"]
        return dataframe
