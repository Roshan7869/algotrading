"""Auto-generated strategy: Alistair Crooks Swing Trading Strategy
  ID: N019 | Tier: tier1 | Source: natural_group
  Components: entry: 4, filter: 2, market_structure: 3, trade_management: 1 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N019(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N019_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N019_short"]
        return dataframe
