"""Auto-generated strategy: Liquidity Catalyst Identification
  ID: C011 | Tier: tier1 | Source: composed
...
class GenStrategy_C011(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C011_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C011_short"]
        return dataframe
