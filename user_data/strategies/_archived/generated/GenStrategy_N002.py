"""Auto-generated strategy: First Red Day Strategy Deep Dive – Alex Tamse
  ID: N002 | Tier: tier1 | Source: natural_group
  Components: entry: 3, filter: 2, risk_management: 2, psychology: 1, market_structure: 1, trade_management: 1 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N002(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N002_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N002_short"]
        return dataframe
