"""Auto-generated strategy: Previous Point of Control (POC) Retest Long
  ID: C025 | Tier: tier2 | Source: composed
...
class GenStrategy_C025(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C025_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C025_short"]
        return dataframe
