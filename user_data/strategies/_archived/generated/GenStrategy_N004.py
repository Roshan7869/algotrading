"""Auto-generated strategy: Low Volume Node Order Flow Strategy Masterclass
  ID: N004 | Tier: tier1 | Source: natural_group
  Components: exit: 1, filter: 6, risk_management: 1, market_structure: 2 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N004(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N004_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N004_short"]
        return dataframe
