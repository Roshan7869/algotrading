"""Auto-generated strategy: Zcash Entry Framework — Higher Low + Non-Rotation Confirmation
  ID: C022 | Tier: tier1 | Source: composed
  Components: entry: 1, filter: 1, risk_management: 1, market_structure: 1, psychology: 1 | Chunks: 5
"""
import numpy as np
import pandas as pd
...
class GenStrategy_C022(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C022_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C022_short"]
        return dataframe
