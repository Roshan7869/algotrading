"""Auto-generated strategy: Right Side of the V — Mean Reversion Entry
  ID: C010 | Tier: tier1 | Source: composed
...
class GenStrategy_C010(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C010_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C010_short"]
        return dataframe
