"""Auto-generated strategy: Moving Averages
  ID: N009 | Tier: tier1 | Source: natural_group
  Components: entry: 2, filter: 1, risk_management: 1, psychology: 1, market_structure: 1 | Chunks: 6
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N009(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N009_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N009_short"]
        return dataframe
