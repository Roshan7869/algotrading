"""Auto-generated strategy: Fractal Strategy Application — Higher Timeframe Swing Variant
  ID: C008 | Tier: tier1 | Source: composed
...
class GenStrategy_C008(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C008_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C008_short"]
        return dataframe
