"""Auto-generated strategy: Previous Day Low Swing Failure Long
  ID: C017 | Tier: tier1 | Source: composed
...
class GenStrategy_C017(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C017_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C017_short"]
        return dataframe
