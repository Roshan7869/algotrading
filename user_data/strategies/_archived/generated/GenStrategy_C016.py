"""Auto-generated strategy: Intraday entry tactics around weakness and VWAP
  ID: C016 | Tier: tier1 | Source: composed
...
class GenStrategy_C016(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False

    minimal_roi = {"0": 0.15, "120": 0.08, "360": 0.04, "720": 0.02}
    stoploss = -0.06
    trailing_stop = True
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "C016_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "C016_short"]
        return dataframe
