"""Auto-generated strategy: Simple 3-Step Price Action Trading Process
  ID: N010 | Tier: tier2 | Source: natural_group
  Components: entry: 1, filter: 1, psychology: 1, market_structure: 2 | Chunks: 5
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N010(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N010_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N010_short"]
        return dataframe
