"""Auto-generated strategy: Kyle Williams First Red Day Strategy
  ID: N022 | Tier: tier1 | Source: natural_group
  Components: entry: 2, filter: 4, risk_management: 1, market_structure: 3 | Chunks: 10
"""
import numpy as np
import pandas as pd
...
class GenStrategy_N022(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_conditions, ["enter_long", "enter_tag"]] = [1, "N022_long"]
        dataframe.loc[short_conditions, ["enter_short", "enter_tag"]] = [1, "N022_short"]
        return dataframe
