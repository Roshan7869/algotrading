"""
Kronos+ChromaDB — Candle Pattern Enhanced.

Base: VectorStrategy_P3E_KEY_LEVEL_BOOST architecture.
Adds: TA-Lib candlestick pattern detection as additional confluence.
"""
...
from user_data.strategies.kronos_chromadb.kronos_indicators import (
    detect_candle_patterns, candle_score, chromadb_confluence_boost
)


class Kronos_CandlePattern(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1h"
    can_short: bool = False

    # ROI & Stop — hyperopt-tested from P3E_KEY_LEVEL_BOOST
    ...
    # Hyperopt params (from P3E_KEY_LEVEL_BOOST)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_signals = [
            ...
            candle_bullish * self.candle_weight.value,
        ]
        ...
        short_signals = [
            ...
            candle_bearish * self.candle_weight.value,
        ]
