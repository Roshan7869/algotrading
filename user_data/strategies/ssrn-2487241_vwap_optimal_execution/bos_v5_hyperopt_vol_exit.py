"""
V5: BOS+LVN+VWAP — Hyperopt-Ready + Volume-Weighted Exit
===========================================================
Paper 3 (ssrn-2487241) volume-weighted exit: tighten trail when
volume drops below 70% of 24h avg (trend exhaustion signal).
...
class BOS_V5_Hyperopt_VolExit(IStrategy):
